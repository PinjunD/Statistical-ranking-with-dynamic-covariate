...
def horse_cross_validation(T,cov,n,subset,data_path,CV_filename):
    ...
    top_likelihood_pl = multi_likelihood(Ttest,Xtest,u_pl,v_pl,l=1)
    three_likelihood_pl = multi_likelihood(Ttest,Xtest,u_pl,v_pl,l=3)
    ...
    top_likelihood_plusDC = multi_likelihood(Ttest,Xtest,u_plusDC,v_plusDC,l=1)
    three_likelihood_plusDC = multi_likelihood(Ttest,Xtest,u_plusDC,v_plusDC,l=3)
...
### Fully capture
### A toy code to test 'fully capture'
